...
%\institute[JSC]{Cross Sectional Team Deep Learning, Helmholtz AI, LAION @ JSC}
\institute[JSC]{Scalable Learning \& Multi-Purpose AI Lab, Helmholtz AI, LAION @ JSC}
\date{2023-04-11}
\title{Day 4: Towards Scalable Deep Learning}
\subtitle{Outlook on Advanced Distributed Training}
% \subtitle{Very Large Models and Data}
% \subtitle{Distributed Training with Large Data and Scaling}
...
\titlegraphic{\includegraphics[width=\paperwidth]{../images/placeholder}}
