...
def main():
    ...
    with zipfile.ZipFile(DATASET_PATH, 'r') as zipped_data:
        ...
        # Task 1: Implement sharding for the image paths so all
        #         processes receive the same number of objects
        #         (see notebook task description for details).
        #         The iterator below should then work.
        # image_names_shard = ...
    ...
    # Task 2: Use one of the two MPI communication functions you learned
    #         about to sum up the histograms from each process (variable
    #         `histograms`) in the variable `collected_histograms`.
