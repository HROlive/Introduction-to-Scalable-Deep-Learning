# Source from: https://github.com/tensorflow/addons/blob/ab413bd5f9c1fbf5ae8435da9eb4aac724ce49fd/tensorflow_addons/optimizers/lamb.py
...
class LAMB(tf.keras.optimizers.Optimizer):
    ...
    def __init__(
        self,
        learning_rate: Union[float, Callable] = 0.001,
        beta_1: float = 0.9,
        beta_2: float = 0.999,
        epsilon: float = 1e-6,
