...
train_data = get_dataset('/p/project/training2306/datasets/tiny-imagenet-200-train.tfrecords', batch_size=batch_size, training=True)
validation_data = get_dataset('/p/project/training2306/datasets/tiny-imagenet-200-val.tfrecords', batch_size=batch_size, training=False)
test_data = get_dataset('/p/project/training2306/datasets/tiny-imagenet-200-test.tfrecords', batch_size=batch_size, training=False)
